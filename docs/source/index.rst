...
This is the output of the algorithm using the default parameters (same parameters for all graphs).
Note that the result is "decent" but nowhere near the precision of iterative methods. 
